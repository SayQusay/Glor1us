...
# Fungsi untuk mengunduh file dari OneDrive/SharePoint
...
def dashboard_page():
    ...
    with col1:
        st.markdown(
            """
            <div style="text-align: center; padding: 24px; border: 5px solid #ddd; border-radius: 10px;">
                <div style="display: flex; justify-content: center; align-items: center; height: 60px;">
                    <i class="fas fa-bolt" style="font-size: 25px; color: orange;"></i>
                </div>
                <h3>Klasifikasi citra lebih cepat</h3>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with col2:
        st.markdown(
            ...
            <div style="text-align: center; padding: 24px; border: 5px solid #ddd; border-radius: 10px;">
                <div style="display: flex; justify-content: center; align-items: center; height: 60px;">
                    <i class="fas fa-brain" style="font-size: 25px; color: pink;"></i>
                </div>
                <h4>Klasifikasi jenis tumor otak dan non-tumor</h3>
            </div>
            """,
            unsafe_allow_html=True
        )
    ...
    with col3:
        st.markdown(
            """
            <div style="text-align: center; padding: 10px; border: 5px solid #ddd; border-radius: 10px;">
                <div style="display: flex; justify-content: center; align-items: center; height: 60px;">
                    <i class="fas fa-cogs" style="font-size: 25px; color: grey;"></i>
                </div>
                <h4>Menggunakan model hybrid machine learning</h3>
            </div>
            """,
            unsafe_allow_html=True
        )
